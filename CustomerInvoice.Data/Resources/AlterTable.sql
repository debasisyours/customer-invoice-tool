...
IF NOT EXISTS(SELECT NULL FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Client' AND COLUMN_NAME = 'Nursing')
	ALTER TABLE dbo.[Client] ADD [Nursing] BIT DEFAULT(0) WITH VALUES

IF NOT EXISTS(SELECT NULL FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Client' AND COLUMN_NAME = 'SelfFunding')
	ALTER TABLE dbo.[Client] ADD [SelfFunding] BIT DEFAULT(0) WITH VALUES

IF NOT EXISTS(SELECT NULL FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Client' AND COLUMN_NAME = 'Residential')
	ALTER TABLE dbo.[Client] ADD [Residential] BIT DEFAULT(0) WITH VALUES